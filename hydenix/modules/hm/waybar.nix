  ...
  config = lib.mkIf cfg.enable {
    home.packages =
      ...
      lib.optionals cfg.waybar.enable [
        ...
        # python3Packages.pyamdgpuinfo # AMD GPU information library
    ...
    home.file = {
      ...
      ".config/waybar/config.jsonc" = {
        text = builtins.replaceStrings
          [ "\"\$XDG_CONFIG_HOME/waybar/modules/*json*\"," "\"\$XDG_DATA_HOME/waybar/modules/*json*\"" "// \"\$XDG_CONFIG_HOME/waybar/includes/includes.json\"" ]
          [ "\"${config.xdg.configHome}/waybar/modules/*json*\"," "\"${config.xdg.dataHome}/waybar/modules/*json*\"," "\"${config.xdg.configHome}/waybar/includes/includes.json\"" ]
