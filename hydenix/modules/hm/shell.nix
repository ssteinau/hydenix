...
in
{
  options.hydenix.hm.shell = {
    ...
    starship = {
      ...
      userConfig = lib.mkOption {
        ...
        default = {};
        description = "User starship configuration that overrides Hyde's default. When set, completely replaces Hyde's starship.toml.";
      };
    };
  ...
  config = lib.mkIf cfg.enable {
    ...
    home.file = lib.mkMerge [
      ...
      # Starship configs - use userConfig if provided, otherwise use Hyde defaults
